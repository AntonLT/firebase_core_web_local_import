...
class FirebaseCoreWeb extends FirebasePlatform {
  ...
  static void registerWith(Registrar registrar) {
    ...
    importJsLibrary(url: "./assets/firebase-app.js", flutterPluginName: "firebase_core_web");
    importJsLibrary(url: "./assets/firebase-messaging-sw.js", flutterPluginName: "firebase_core_web");
    importJsLibrary(url: "./assets/firebase-messaging.js", flutterPluginName: "firebase_core_web");
    importJsLibrary(url: "./assets/firebase-analytics.js", flutterPluginName: "firebase_core_web");
  }
  ...
  String get _firebaseSDKVersion {
    return context['flutterfire_web_sdk_version'] ?? supportedFirebaseJsSdkVersion;
  }
  ...
  List<String> get _ignoredServiceScripts {
    try {
      JsObject ignored = JsObject.fromBrowserObject(context['flutterfire_ignore_scripts']);

      if (ignored is Iterable) {
        return (ignored as Iterable).map((e) => e.toString()).toList(growable: false);
      }
    } catch (e) {
      // Noop
    }
